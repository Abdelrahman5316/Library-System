    ...
    public ViewIssuedBooks() {
      ...
      String[] X=new String[7];
       for(i=0;i<Reader.issued.size();i++){
          X[0]=Integer.toString(Reader.issued.get(i).getId());
          X[1]= Reader.issued.get(i).getBookCallno();
          X[2]= Reader.issued.get(i).getStudentid();
          X[3]= Reader.issued.get(i).getStudentName();
          X[4]= Reader.issued.get(i).getStudentContact();
          X[5]= Reader.issued.get(i).getIssueDate().toString();
          model.addRow(X);
       } 
