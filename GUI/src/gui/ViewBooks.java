...
public class ViewBooks extends javax.swing.JFrame {
    ...
    public ViewBooks() {
       ...
       String[] X=new String[8];
        ...
        X[0]=Integer.toString(i+1);
        X[1]=Reader.books.get(i).getCallNo();
        X[2]=Reader.books.get(i).getName();
        X[3]=Reader.books.get(i).getAuthor();
        X[4]=Reader.books.get(i).getPublisher();
        X[5]=Integer.toString(Reader.books.get(i).getQuantity());
        X[6]=Integer.toString(Reader.books.get(i).getIssuedBooks());
        X[7]=Reader.books.get(i).getAddedDate();
        model.addRow(X);
        }
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Bookcallno.", "name", "author", "publisher", "quantity", "issued", "added_date"
            }
        ));
